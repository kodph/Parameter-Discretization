...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 10.0 2021-04-01",
    "libcarmaker.a	CarMaker win64 10.0 2021-04-01",
    "libipgdriver.a	IPGDriver win64 10.0 2021-03-29",
    "libipgroad.a	IPGRoad win64 10.0 2021-03-29",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=100000",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 10.0 - Car_Generic",          /* App_Version         */
    "603",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2021-04-01 16:39:49",  /* App_CompileTime */
